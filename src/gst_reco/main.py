...
from statements_data import bank_statements, book_statements
from crews.compare_statements.compare_statements import CompareStatements
from utils import fetch_book_statements
load_dotenv()
...
class BankReco(Flow[BankRecoState]):
    ...
    def load_statements(self):
        ...
        # book_statements = fetch_book_statements("2023-03-30", "2023-04-01","18119")
        self.state.bank_statements = [
            Statement(**bs) for bs in bank_statements]
        self.state.book_statements = [
            Statement(**bs) for bs in book_statements]
    ...
    async def match_statements(self):
        ...
        for bs in self.state.bank_statements:
            ...
            for bk in candidates:
                ...
                # if False:
                    ...
                    print(
                        f"✅ Fast Matched: {bs.description} ↔ {bk.description}")
        ...
        if verification_needed:
            ...
            for i in range(0, len(verification_needed), batch_size):
                ...
                for match in matches:
                    ...
                    matched_book.append(bk)
                    matched_book_ids.add(id(bk))
                    print(f"🧠 LLM Batch Matched: {bs.description} ↔ {bk.description}")
